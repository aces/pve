...
%  brain area. Calculates also the dice co-efficient (for convinience).


function [error,dice,mcr] = pve_error_exact(filename,mask_filename,varargin);
   ...
   csf_filename = strcat(filename,'_exactcsf.mnc');
   gm_filename  = strcat(filename,'_exactgm.mnc');
   wm_filename  = strcat(filename,'_exactwm.mnc');
